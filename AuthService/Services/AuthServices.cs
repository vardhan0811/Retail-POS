...
public class AuthServices : IAuthService
{
        ...
        ILogger<AuthServices> logger)
    {
        ...
        public async Task<UserIdentityViewDto> UpdateUserRoleAsync(Guid userId, string role)
        {
            if (userId == Guid.Empty)
                throw new BusinessException("User id is required");
        ...
        public async Task<UserIdentityViewDto> UpdateUserStatusAsync(Guid userId, bool isActive)
        {
            if (userId == Guid.Empty)
                throw new BusinessException("User id is required");

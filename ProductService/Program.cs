...
namespace ProductService
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                Log.Fatal("JWT signing key is missing or empty. Configure Jwt:Key in appsettings or appsettings.Local.json.");
                throw new InvalidOperationException("Missing config: Jwt:Key (cannot be empty)");
            }
            ...
            {
                ResponseWriter = ProductService.HealthChecks.HealthCheckResponseWriter.WriteAsync
            }).AllowAnonymous();
